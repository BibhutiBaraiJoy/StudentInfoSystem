...
namespace StudentInfoSystem.Controllers
{
    public class DepartmentController : Controller
    {
        ...
        public ActionResult Create([Bind(Include="DepartmentId,DepartmentName")] Department department)
        {
            ...
            {
                TempData["Dpt"] = "Department Insert Successfully" + " Department Name : " + department.DepartmentName;
        ...
        public JsonResult CheckDeptNameUnikeNess(string departmentname)
        {
            var departmentName = db.Departments.FirstOrDefault(d=>d.DepartmentName==(string)departmentname);
